...
txt_result = tk.Text(frm_result, font=("geogio", 12), yscrollcommand=scroll_bar.set)
...
btn_clear = tk.Button(root, font=("geogio", 15), text="Clear", command=clear)
